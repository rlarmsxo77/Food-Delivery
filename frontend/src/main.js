...
pluralCaseList.push( {plural: "menuReads", pascal: "MenuRead"} )
pluralCaseList.push( {plural: "orderReads", pascal: "OrderRead"} )
pluralCaseList.push( {plural: "orderStores", pascal: "OrderStore"} )
